...
import ChatbotSGEE from '../candidat/ChatbotSGEE';
...
// Pour le manuel classique
const handleDownloadManuel = () => {
  const result = ManualPDFService.generatePDF(candidatManual);
  if (result.success) {
...
// Pour le flowchart d'inscription
const handleDownloadFlowchart = () => {
  const result = ManualPDFService.generateEnrollementFlowchartPDF(
    enrollementFlowchart, 
    enrollementFlowcharts
  );
  if (result.success) {
    console.log('✅ Flowchart PDF téléchargé:', result.fileName);
  } else {
    alert('Erreur: ' + result.error);
  }
};
...
{/* Section FAQ */}
      <div className="bg-white py-16" id="faq">
        <div className="max-w-4xl mx-auto px-4">
          ...
          {/* ✅ Bouton Manuel centré avec meilleur espacement */}
          <div className="mt-12 flex justify-center">
            <BoutonManuel />
          </div>

          {/* ✅ Alternative: Bouton avec contexte */}
          {/* 
          <div className="mt-12 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 text-center">
            <div className="max-w-2xl mx-auto">
              ...
              <p className="text-gray-600 mb-6">
                Consultez notre guide complet pour plus de détails sur le processus d'inscription
              </p>
              <BoutonManuel />
            </div>
          </div>
